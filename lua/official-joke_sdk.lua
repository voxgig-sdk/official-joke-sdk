...
local OfficialJokeSDK = {}
OfficialJokeSDK.__index = OfficialJokeSDK
...
OfficialJokeSDK._make_feature = _make_feature


function OfficialJokeSDK.new(options)
  local self = setmetatable({}, OfficialJokeSDK)
  self.mode = "live"
  self.features = {}
  self.options = nil
...
function OfficialJokeSDK:options_map()
...
function OfficialJokeSDK:get_utility()
  return Utility.copy(self._utility)
end


function OfficialJokeSDK:get_root_ctx()
  return self._rootctx
end


function OfficialJokeSDK:prepare(fetchargs)
...
function OfficialJokeSDK:direct(fetchargs)
...
-- by passing it.
function OfficialJokeSDK:_raw_request(fetchargs)
  local utility = self._utility
...
function OfficialJokeSDK:graphql(query, variables, ctrl)
  ...
  if type(errors) == "table" and 0 < #errors then
    ...
    res.ok = false
    res.err = "OfficialJokeSDK: graphql: " .. msg
    res.graphql = errors
  end
...
function OfficialJokeSDK.test(testopts, sdkopts)
  sdkopts = sdkopts or {}
  ...
  local sdk = OfficialJokeSDK.new(sdkopts)
  sdk.mode = "test"
