...
function runner.env_override(m)
  local live = runner.getenv("OFFICIAL_JOKE_TEST_LIVE")
  local override = runner.getenv("OFFICIAL_JOKE_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("OFFICIAL_JOKE_TEST_EXPLAIN")
