...
function runner.env_override(m)
  local live = runner.getenv("OFFICIALJOKE_TEST_LIVE")
  local override = runner.getenv("OFFICIALJOKE_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("OFFICIALJOKE_TEST_EXPLAIN")
