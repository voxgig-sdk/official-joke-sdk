...
func registerSDKWords(r *eng.Registry, client *sdk.OfficialJokeSDK) {
...
func runOp(client *sdk.OfficialJokeSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
