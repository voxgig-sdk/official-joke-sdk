...
from officialjoke_sdk.utility import register

# Load features
from officialjoke_sdk.feature.base_feature import OfficialJokeBaseFeature
from officialjoke_sdk.features import _has_feature, _make_feature
...
class OfficialJokeSDK:
    ...
    def get_utility(self):
        return OfficialJokeUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("OfficialJokeSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Joke(self, data=None) -> "JokeEntity":
        ...
        from officialjoke_sdk.entity.joke_entity import JokeEntity
        return JokeEntity(self, data)


    def Type(self, data=None) -> "TypeEntity":
        """Entity factory: client.Type().list() / client.Type().load({"id": ...})."""
        from officialjoke_sdk.entity.type_entity import TypeEntity
