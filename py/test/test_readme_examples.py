# OfficialJoke SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions OfficialJokeSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both OfficialJokeSDK(...) and OfficialJokeSDK.test(...) become
#      OfficialJokeSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "officialjoke_sdk"
_SDK_CLASS = "OfficialJokeSDK"
