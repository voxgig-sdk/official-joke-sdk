# OfficialJoke Python SDK



The Python SDK for the OfficialJoke API — an entity-oriented client following Pythonic conventions.
...
release tag (`py/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/official-joke-sdk/releases)) or
...
```
py/
├── officialjoke_sdk.py         -- Main SDK module
