# OfficialJoke TypeScript SDK Reference

Complete API reference for the OfficialJoke TypeScript SDK.
...
```ts
new OfficialJokeSDK(options?: object)
```
...
#### `OfficialJokeSDK.test(testopts?, sdkopts?)`
...
**Returns:** `OfficialJokeSDK` instance in test mode.
...
Alias for `OfficialJokeSDK.test()`.
...
| Action | Route | Call |
| --- | --- | --- |
| `ten` | `/jokes/{type}/ten` | `client.Joke().list({ $action: 'ten', ... })` |
| `ten` | `/jokes/ten` | `client.Joke().list({ $action: 'ten', ... })` |
| `random` | `/jokes/{type}/random` | `client.Joke().load({ $action: 'random', ... })` |
| `random` | `/jokes/random` | `client.Joke().load({ $action: 'random', ... })` |
...
Return the parent `OfficialJokeSDK` instance.
