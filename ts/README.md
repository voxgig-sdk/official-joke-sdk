...
The TypeScript SDK for the OfficialJoke API. Provides a type-safe, entity-oriented interface with full async/await support.
...
```ts
const client = new OfficialJokeSDK({ apikey: '...' })
