# OfficialJoke TypeScript SDK



The TypeScript SDK for the OfficialJoke API — a type-safe, entity-oriented client with full async/await support.

The API is exposed as capitalised, semantic **Entities** — e.g.
`client.Joke()` — each with a small set of operations (`list`, `load`)
...
| `tester(testopts?, sdkopts?)` | `OfficialJokeSDK` | Create a test-mode client instance. |

#### Static methods

| Method | Returns | Description |
| --- | --- | --- |
| `OfficialJokeSDK.test(testopts?, sdkopts?)` | `OfficialJokeSDK` | Create a test-mode client. |
...
| `client` | `client(): OfficialJokeSDK` | Return the parent SDK client. |
...
official-joke/
├── src/
│   ├── OfficialJokeSDK.ts        # Main SDK class
