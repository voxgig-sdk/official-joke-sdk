...
// OfficialJoke SDK clienttrack feature
...
class OfficialJokeClienttrackFeature extends OfficialJokeBaseFeature
{
    ...
    public function PostConstruct(OfficialJokeContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'OfficialJoke-SDK';
