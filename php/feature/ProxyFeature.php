...
// OfficialJoke SDK proxy feature
...
class OfficialJokeProxyFeature extends OfficialJokeBaseFeature
{
    ...
    public function init(OfficialJokeContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (OfficialJokeContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
