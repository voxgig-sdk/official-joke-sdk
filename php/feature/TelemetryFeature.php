...
// OfficialJoke SDK telemetry feature
...
class OfficialJokeTelemetryFeature extends OfficialJokeBaseFeature
{
    ...
    private function _close(OfficialJokeContext $ctx, bool $ok): void
    {
