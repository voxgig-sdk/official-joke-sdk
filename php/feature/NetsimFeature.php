...
// OfficialJoke SDK netsim feature
...
class OfficialJokeNetsimFeature extends OfficialJokeBaseFeature
{
    ...
    private function _simulate(OfficialJokeContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(OfficialJokeContext $ctx, array $applied): void
    {
        $client = $this->client;
