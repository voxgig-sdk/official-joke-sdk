...
// OfficialJoke SDK cache feature
...
class OfficialJokeCacheFeature extends OfficialJokeBaseFeature
{
    ...
    private function _through(OfficialJokeContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
