...
class OfficialJokeTestRunner
{
    ...
    {
        $live = self::getenv('OFFICIAL_JOKE_TEST_LIVE');
        $override = self::getenv('OFFICIAL_JOKE_TEST_OVERRIDE');
        ...
        $explain = self::getenv('OFFICIAL_JOKE_TEST_EXPLAIN');
...
class_alias('OfficialJokeTestRunner', 'Runner');
class_alias('OfficialJokeHelpers', 'Helpers');
