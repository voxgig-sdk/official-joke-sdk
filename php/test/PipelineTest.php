...
// OfficialJoke SDK pipeline test
//
...
require_once __DIR__ . '/../officialjoke_sdk.php';
...
{
    private static function utility(): OfficialJokeUtility
    {
        return new OfficialJokeUtility();
    }
    ...
    private static function ctx(array $over = []): OfficialJokeContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new OfficialJokeContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new OfficialJokeOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof OfficialJokeError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new OfficialJokeOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = OfficialJokeMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new OfficialJokeOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = OfficialJokeMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new OfficialJokeOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = OfficialJokeMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new OfficialJokeSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = OfficialJokeMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new OfficialJokeResponse([]),
            'result' => new OfficialJokeResult([]),
        ]);
        [, $err] = OfficialJokeMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new OfficialJokeSpec([]),
            'response' => null,
            'result' => new OfficialJokeResult([]),
        ]);
        [, $err] = OfficialJokeMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new OfficialJokeSpec(['step' => 's']),
            'response' => new OfficialJokeResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new OfficialJokeResult([]),
        ]);
        [, $err] = OfficialJokeMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new OfficialJokeSpec(['step' => 's']),
            'response' => new OfficialJokeResponse(self::resp(200, ['v' => 1])),
            'result' => new OfficialJokeResult([]),
        ]);
        [, $err] = OfficialJokeMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new OfficialJokeSpec(['step' => 's']),
            'response' => new OfficialJokeResponse(self::resp(200, ['v' => 2])),
            'result' => new OfficialJokeResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        OfficialJokeMakeResponse::call($ctx);
    ...
    {
        $preset = new OfficialJokeResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new OfficialJokeSpec([]),
            'response' => new OfficialJokeResponse([]),
            'result' => new OfficialJokeResult([]),
        ...
        [$got, $err] = OfficialJokeMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new OfficialJokeResult([])]);
        [, $err] = OfficialJokeMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new OfficialJokeSpec([]), 'result' => null]);
        [, $err] = OfficialJokeMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new OfficialJokeSpec(['step' => 's']),
            'result' => new OfficialJokeResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new OfficialJokeOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = OfficialJokeMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new OfficialJokeSpec(['step' => 's']),
            'result' => new OfficialJokeResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new OfficialJokeOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = OfficialJokeMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new OfficialJokeResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new OfficialJokeSpec([]),
            'result' => new OfficialJokeResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = OfficialJokeMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = OfficialJokeMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new OfficialJokeError('boom', 'boom');
        $utility->fetcher = function (OfficialJokeContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new OfficialJokeSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = OfficialJokeMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (OfficialJokeContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = OfficialJokeMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(OfficialJokeResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        OfficialJokeMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (OfficialJokeContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new OfficialJokeSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = OfficialJokeMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new OfficialJokeResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new OfficialJokeSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = OfficialJokeMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = OfficialJokeMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = OfficialJokeMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new OfficialJokeResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, OfficialJokeDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new OfficialJokeResult(['ok' => false])]);
        $this->expectException(OfficialJokeError::class);
        OfficialJokeDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new OfficialJokeResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', OfficialJokeMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        OfficialJokeMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new OfficialJokeBaseFeature();
        $b = new OfficialJokeBaseFeature();
        OfficialJokeFeatureAdd::call($ctx, $a);
        OfficialJokeFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): OfficialJokeBaseFeature
    {
        $f = new OfficialJokeBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        OfficialJokeFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): OfficialJokeContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new OfficialJokeSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = OfficialJokePrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        OfficialJokePrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new OfficialJokeResponse(['headers' => null]),
            'result' => new OfficialJokeResult([]),
        ]);
        OfficialJokeResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        OfficialJokeResultBody::call($ctx);
