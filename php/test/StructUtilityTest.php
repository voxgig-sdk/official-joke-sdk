...
// OfficialJoke SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = OfficialJokeOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(OfficialJokeOmni::structfix($now, Struct::undef()))
                        !== json_encode(OfficialJokeOmni::structfix($val, Struct::undef()))) {
