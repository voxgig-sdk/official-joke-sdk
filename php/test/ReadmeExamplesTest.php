...
// OfficialJoke SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (OfficialJokeSDK::test)
...
{
    private const SDK_CLASS = 'OfficialJokeSDK';
    ...
    private const SDK_BASE = 'officialjoke_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../officialjoke_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
