# OfficialJoke PHP SDK Reference

Complete API reference for the OfficialJoke PHP SDK.
...
#### `OfficialJokeSDK::test($testopts = null, $sdkopts = null)`
...
#### `get_utility(): OfficialJokeUtility`
