...
// OfficialJoke SDK utility: graphql
//
...
class OfficialJokeGraphql
{
    ...
    // equivalent.
    public static function body(OfficialJokeContext $ctx): mixed
    {
    ...
    public static function errors(OfficialJokeContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
