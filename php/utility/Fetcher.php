...
// OfficialJoke SDK utility: fetcher

class OfficialJokeFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; OfficialJokeSDK/1.0)';
    ...
    public static function call(OfficialJokeContext $ctx, string $fullurl, array $fetchdef): array
    {
