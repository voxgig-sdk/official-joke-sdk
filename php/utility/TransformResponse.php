...
// OfficialJoke SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class OfficialJokeTransformResponse
{
    public static function call(OfficialJokeContext $ctx): mixed
    {
        ...
        $transform = OfficialJokeHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
