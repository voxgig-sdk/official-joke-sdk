...
// OfficialJoke SDK utility: make_options

class OfficialJokeMakeOptions
{
    ...
    public static function call(OfficialJokeContext $ctx): array
    {
        ...
        //
        // `OfficialJokeSchema::optspec()` is built from the model:
        ...
        $optspec = OfficialJokeSchema::optspec();
