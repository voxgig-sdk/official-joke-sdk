...
// OfficialJoke SDK utility type

class OfficialJokeUtility
{
    ...
    public static function copy(OfficialJokeUtility $src): OfficialJokeUtility
    {
        $u = new OfficialJokeUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
