...
|---|---|---|
| `ts/` | @voxgig-sdk/official-joke-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/official-joke-sdk \
      --repository voxgig-sdk/official-joke-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/official-joke-sdk` shows it, and
`npm trust revoke @voxgig-sdk/official-joke-sdk --id=<id>` removes it.
