...
from projectname_sdk.core.control import OfficialJokeControl
...
class OfficialJokeContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(sp, OfficialJokeSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, OfficialJokeResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, OfficialJokeResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return OfficialJokeError(code, msg, self)
