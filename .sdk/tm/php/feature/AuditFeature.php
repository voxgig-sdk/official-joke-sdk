...
// OfficialJoke SDK audit feature
...
class OfficialJokeAuditFeature extends OfficialJokeBaseFeature
{
    ...
    private function _emit(OfficialJokeContext $ctx, string $outcome): void
    {
