...
// OfficialJoke SDK streaming feature
...
class OfficialJokeStreamingFeature extends OfficialJokeBaseFeature
{
    ...
    private function _iterate(OfficialJokeResult $result): \Generator
    {
    ...
    private function _streamable(OfficialJokeContext $ctx): bool
    {
