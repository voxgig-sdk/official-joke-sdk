...
// OfficialJoke SDK timeout feature
...
class OfficialJokeTimeoutFeature extends OfficialJokeBaseFeature
{
    ...
    private function _with_timeout(OfficialJokeContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(OfficialJokeContext $_ctx, float $ms): void
    {
        $client = $this->client;
