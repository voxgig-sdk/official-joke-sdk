...
// OfficialJoke SDK ratelimit feature
...
class OfficialJokeRatelimitFeature extends OfficialJokeBaseFeature
{
    ...
    private function _acquire(OfficialJokeContext $ctx): void
    {
    ...
    private function _track(OfficialJokeContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
