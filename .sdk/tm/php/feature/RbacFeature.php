...
class OfficialJokeRbacFeature extends OfficialJokeBaseFeature
{
    ...
    private function _required(OfficialJokeContext $ctx): ?string
    {
    ...
    private function _reject(OfficialJokeContext $ctx, string $required): void
    {
    ...
    private function _track(OfficialJokeContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
