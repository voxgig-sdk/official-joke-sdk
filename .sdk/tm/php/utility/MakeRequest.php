...
// OfficialJoke SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class OfficialJokeMakeRequest
{
    public static function call(OfficialJokeContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new OfficialJokeResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new OfficialJokeResponse($fetched);
        } else {
