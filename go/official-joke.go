...
// instead of `sdk.NewOfficialJokeSDK(nil)` / `sdk.TestSDK(nil, nil)`
// for the common no-options case.
func New() *OfficialJokeSDK  { return NewOfficialJokeSDK(nil) }
func Test() *OfficialJokeSDK { return TestSDK(nil, nil) }
