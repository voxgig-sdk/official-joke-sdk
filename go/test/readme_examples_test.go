...
const testSeed = `map[string]any{"entity": map[string]any{"joke": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "type": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
