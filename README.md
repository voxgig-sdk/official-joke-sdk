...
This is an unofficial SDK for the Official Joke public API, generated by Voxgig with [`@voxgig/sdkgen`](https://github.com/voxgig/sdkgen). It is not affiliated with, endorsed by, or sponsored by the upstream API provider.
...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/official-joke` | `npm install @voxgig-sdk/official-joke` |
| Python | `voxgig-sdk-official-joke` | `pip install voxgig-sdk-official-joke` |
| PHP | `voxgig-sdk/official-joke` | `composer require voxgig-sdk/official-joke` |
| Golang | `github.com/voxgig-sdk/official-joke-sdk/go` | `go get github.com/voxgig-sdk/official-joke-sdk/go` |
| Ruby | `voxgig-sdk-official-joke` | `gem install voxgig-sdk-official-joke` |
| Lua | `voxgig-sdk-official-joke` | `luarocks install voxgig-sdk-official-joke` |
