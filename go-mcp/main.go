// Command OfficialJoke-mcp is an MCP server exposing the OfficialJoke
// SDK as MCP tools.
//
// Two tools are registered:
//
//	OfficialJoke_list  — list records of an entity
//	OfficialJoke_load  — load a single record of an entity
//
