...
type Args struct {
	Entity string         `json:"entity" jsonschema:"joke | type"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.OfficialJokeSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "official-joke_list",
		Description: "List records from OfficialJoke. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "official-joke_load",
		Description: "Load a single record from OfficialJoke. " +
...
func runOp(client *sdk.OfficialJokeSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.OfficialJokeSDK, name string) (sdk.OfficialJokeEntity, error) {
